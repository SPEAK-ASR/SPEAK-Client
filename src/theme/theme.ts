    ...
    components: {
        ...
        MuiButton: {
            styleOverrides: {
                ...
                contained: {
                    background:
                        "linear-gradient(135deg, #4F8EFF 0%, rgba(79, 142, 255, 0.8) 100%)",
                    boxShadow: "0 2px 8px rgba(79, 142, 255, 0.3)",
                    "&:hover": {
                        background:
                            "linear-gradient(135deg, #7BA8FF 0%, #4F8EFF 100%)",
        ...
        MuiSlider: {
            styleOverrides: {
                root: {
                    ...
                    "& .MuiSlider-track": {
                        background:
                            "linear-gradient(90deg, #4F8EFF 0%, rgba(79, 142, 255, 0.7) 100%)",
