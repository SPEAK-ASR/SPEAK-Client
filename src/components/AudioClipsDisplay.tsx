...
import type { ProcessingStep } from "../pages/AudioProcessorPage";
...
export function AudioClipsDisplay({
    ...
    const formattedVideoDuration =
        totalDurationSeconds > 0 ? formatTime(totalDurationSeconds) : "–";
    ...
    const handleAudioEnded = () => {
        ...
        const currentIndex = clips.findIndex(
            (clip) => clip.clip_name === selectedClip?.clip_name,
        );
                        ...
                        >
                            <Box>
                                ...
                                >
                                    ...
                                    >
                                        {videoAuthor} • {formattedVideoDuration}{" "}
                                        • {clips.length} clips
                                    </Typography>
                                </Box>
                            </Box>
