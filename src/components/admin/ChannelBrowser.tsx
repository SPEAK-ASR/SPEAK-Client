...
export const ChannelBrowser: React.FC = () => {
    ...
    const [deletingChannels, setDeletingChannels] = useState<Set<string>>(
        new Set(),
    );
    ...
    const channelsByCategory = useMemo(() => {
        ...
        return categoryOrder
            ...
            .map(
                (category) =>
                    [category, map.get(category)!] as [string, ChannelCard[]],
            );
    }, [channels]);
    ...
    return (
        <Stack spacing={4} sx={{ color: "#f5f5f5" }}>
            {error && (
                <Alert
                    severity="error"
                    sx={{ bgcolor: "error.dark", color: "common.white" }}
                >
                        ...
                        >
                            ...
                            >
                                {list
                                    .filter(
                                        (ch) =>
                                            !deletingChannels.has(ch.channelId),
                                    )
                                    .map((ch) => (
                                        <ChannelCardItem
...
const ChannelCardItem: React.FC<ChannelCardItemProps> = ({
    ...
    const fallbackGradient =
        "linear-gradient(135deg, #ff4d6d 0%, #6a4dff 50%, #00d2ff 100%)";
        ...
        >
            ...
            <Box
                sx={{
                    ...
                    inset: 0,
                    background:
                        "linear-gradient(180deg, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.85) 80%)",
                    pointerEvents: "none",
                }}
            />
            ...
            >
                ...
                <Stack
                    ...
                    sx={{
                        ...
                        transition:
                            "height 200ms ease, opacity 160ms ease, transform 180ms ease",
                        overflow: "hidden",
                        pointerEvents: "none",
                    }}
                >
