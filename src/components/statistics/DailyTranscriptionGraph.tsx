...
export function DailyTranscriptionGraph({
    data,
    days,
    onDaysChange,
}: DailyTranscriptionGraphProps) {
    ...
    const totalTranscriptions = displayData.reduce(
        (sum, d) => sum + d.transcription_count,
        0,
    );
    const avgPerDay =
        displayData.length > 0 ? totalTranscriptions / displayData.length : 0;
    const totalHours = displayData.reduce(
        (sum, d) => sum + d.total_duration_hours,
        0,
    );
            ...
            <Box sx={{ p: 2 }}>
                ...
                >
                    <Typography variant="body2" sx={{ color: "#b0bec5" }}>
                        Transcription trends over the last {displayData.length}{" "}
                        days
                    </Typography>
                    <ToggleButtonGroup
                        value={days}
                ...
                <Box
                    sx={{
                        ...
                        p: 1.5,
                        background:
                            "linear-gradient(135deg, rgba(100, 181, 246, 0.15) 0%, rgba(63, 81, 181, 0.15) 100%)",
                        borderRadius: 2,
