                ...
                >
                    ...
                    <Box
                        sx={{
                            ...
                            borderRadius: 2,
                            background:
                                "linear-gradient(135deg, rgba(102, 187, 106, 0.2) 0%, rgba(76, 175, 80, 0.2) 100%)",
                    ...
                    >
                        ...
                        >
                            <CheckCircle
                                sx={{ color: "#81c784", mr: 1, fontSize: 20 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
                    ...
                    >
                        ...
                        >
                            <RadioButtonUnchecked
                                sx={{ color: "#90a4ae", mr: 1, fontSize: 20 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
                        ...
                        <Typography variant="caption" sx={{ color: "#b0bec5" }}>
                            {data.non_transcribed_duration_hours.toFixed(2)}{" "}
                            hours
                        </Typography>
                    </Box>
                </Box>
