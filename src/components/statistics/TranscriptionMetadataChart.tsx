...
export function TranscriptionMetadataChart({
    data,
}: TranscriptionMetadataChartProps) {
    ...
    const genderLabels = data.speaker_gender.map(
        (item) => item.gender.charAt(0).toUpperCase() + item.gender.slice(1),
    );
    ...
    const overlappingData = [
        {
            id: 0,
            value: data.speaker_overlapping.without_overlap,
            color: "#66bb6a",
        },
        {
            id: 1,
            value: data.speaker_overlapping.with_overlap,
            color: "#ef5350",
        },
        ...
        >
            <Box sx={{ p: 2 }}>
                <Box sx={{ display: "flex", alignItems: "center", mb: 0.5 }}>
                    <VerifiedUser
                        sx={{ mr: 1, color: "#64b5f6", fontSize: 22 }}
                    />
                ...
                <Typography variant="body2" sx={{ mb: 2, color: "#b0bec5" }}>
                    Quality indicators and metadata for{" "}
                    {data.total_transcriptions.toLocaleString()} transcriptions
                </Typography>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <VerifiedUser
                                sx={{ color: "#64b5f6", mr: 0.5, fontSize: 18 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
                    ...
                    <Box
                        sx={{
                            ...
                            borderRadius: 2,
                            background:
                                "linear-gradient(135deg, rgba(186, 104, 200, 0.1) 0%, rgba(156, 39, 176, 0.1) 100%)",
                    ...
                    >
                        ...
                        >
                            <RecordVoiceOver
                                sx={{ color: "#ba68c8", mr: 0.5, fontSize: 18 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
                    ...
                    >
                        ...
                        >
                            <VolumeUp
                                sx={{ color: "#81c784", mr: 0.5, fontSize: 18 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
                    ...
                    <Box
                        sx={{
                            ...
                            borderRadius: 2,
                            background:
                                "linear-gradient(135deg, rgba(255, 183, 77, 0.1) 0%, rgba(255, 152, 0, 0.1) 100%)",
                    ...
                    >
                        ...
                        >
                            <Translate
                                sx={{ color: "#ffb74d", mr: 0.5, fontSize: 18 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
                    ...
                    <Box
                        sx={{
                            ...
                            borderRadius: 2,
                            background:
                                "linear-gradient(135deg, rgba(239, 83, 80, 0.1) 0%, rgba(244, 67, 54, 0.1) 100%)",
                    ...
                    >
                        ...
                        >
                            <Groups
                                sx={{ color: "#ef5350", mr: 0.5, fontSize: 18 }}
                            />
                            <Typography
                                variant="body2"
                                fontWeight="bold"
