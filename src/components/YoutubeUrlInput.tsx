...
import { YouTube, Send, Info, Settings, ExpandMore } from "@mui/icons-material";
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <MenuItem value="law_and_justice">
                                Law and Justice
                            </MenuItem>
                            ...
                            <MenuItem value="media_marketing">
                                Media Marketing
                            </MenuItem>
                            <MenuItem value="history_and_cultural">
                                History and Cultural
                            </MenuItem>
                            <MenuItem value="work_and_careers">
                                Work and Careers
                            </MenuItem>
                    ...
                    <Box sx={{ minWidth: 200, px: 1 }}>
                        ...
                        <Slider
                            value={vadThreshold}
                            onChange={(_, value) =>
                                setVadThreshold(value as number)
                            }
                            min={0}
                            max={1}
                            step={0.01}
                                ...
                                >
                                    ...
                                    <Box sx={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <Slider
                                            value={startPadding}
                                            onChange={(_, value) =>
                                                setStartPadding(value as number)
                                            }
                                            min={0}
                                            max={5}
                                            step={0.1}
