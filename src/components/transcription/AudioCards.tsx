...
interface ReferenceCardProps {
  ...
  onCopy: () => void;
  /** Callback for copying to clipboard without scoring */
  onCopyNoScore?: () => void;
  /** Title for the card */
  title?: string;
}
  ...
  return (
    <Card variant="outlined">
      ...
      <CardContent>
        ...
        <Typography sx={{ whiteSpace: "pre-wrap", mb: 2 }}>{text}</Typography>
          ...
          {children || (
            <Box component="ul" sx={{ pl: 3, m: 0 }}>
              <li style={{ marginBottom: 8 }}>
                Transcribe exactly what you hear in Sinhala. Keep English words
                in English.
              </li>
              <li style={{ marginBottom: 8 }}>
                Enable the Sinhala phonetic keyboard if you do not have a native
                keyboard. Toggle via the chip or <kbd>Ctrl</kbd> +{" "}
                <kbd>Space</kbd>.
              </li>
              <li style={{ marginBottom: 8 }}>
                Skip fillers that do not add meaning (e.g., "ම්ම්").
              </li>
              <li>
                Complete the metadata section after transcribing (speaker
                gender, noise, overlaps, etc.).
              </li>
            </Box>
          )}
        </CardContent>
