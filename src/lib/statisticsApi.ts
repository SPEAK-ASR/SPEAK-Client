...
export const statisticsApi = {
     ...
     */
    getCategoryDurations: async (): Promise<{
        success: boolean;
     ...
     */
    getTranscriptionStatus: async (): Promise<{
        success: boolean;
     ...
     */
    getDailyTranscriptions: async (
        days: number = 30,
    ): Promise<{ success: boolean; data: DailyTranscriptionData[] }> => {
     ...
     */
    getAdminContributions: async (): Promise<{
        success: boolean;
     ...
     */
    getAudioDistribution: async (): Promise<{
        success: boolean;
