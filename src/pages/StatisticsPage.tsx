...
export function StatisticsPage() {
    ...
    const fetchDailyStatistics = async (selectedDays: 7 | 30) => {
        try {
            const data =
                await statisticsApi.getDailyTranscriptions(selectedDays);
            setStatistics((prev) =>
                prev ? { ...prev, daily_transcriptions: data.data } : null,
            );
        } catch (err) {
        ...
        >
            ...
            <Box sx={{ display: "grid", gap: 2, mb: 2 }}>
                ...
                >
                    ...
                    >
                        <MemoizedTranscriptionStatusChart
                            data={statistics.transcription_status}
                        />
                        <MemoizedCategoryDurationChart
                            data={statistics.category_durations}
                        />
                        <MemoizedAdminContributionChart
                            data={statistics.admin_contributions}
                        />
                    </Box>
                    {/* Right Column */}
                    <Box
                    ...
                    >
                        <MemoizedAudioDistributionGraph
                            data={statistics.audio_distribution}
                        />
